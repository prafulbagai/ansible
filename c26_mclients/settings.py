...
if not DEBUG:
    ...
    AWS_STORAGE_BUCKET_NAME = 'message_groups'
    AWS_ACCESS_KEY_ID = 'AKIAIJTB5PGFHQVQH7MQ'
    AWS_SECRET_ACCESS_KEY = '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'
    AWS_S3_HOST = 's3.ap-south-1.amazonaws.com'
    # Tell django-storages that when coming up with the URL for an item in
    # S3 storage, keep it simple - just use this domain plus the path. (If this
    # isn't set, things get complicated). This controls how the `static` template
    # tag from `staticfiles` gets expanded, if you're using it.
    ...
    DEFAULT_FILE_STORAGE = 'sellold.custom_storages.MediaStorage'
